## *************************************************************************
## Example of identifying DEGs between normal and abnormal by using MAST 
## approach. "for" loop was used to run multiple cell types per run
...
## 	col 1: cluster ID 
##	col 2: associated cell types. Use "NA" to indicate clusters excluded
##             from the analysis because of sample specific clustersy
...
fin2 <- c("example/GGO_cd45neg_selClusters4DEG.txt")  #***w/disease status
